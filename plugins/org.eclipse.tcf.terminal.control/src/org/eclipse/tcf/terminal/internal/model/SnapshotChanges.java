 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.internal.model;
...
public class SnapshotChanges implements ISnapshotChanges {
    ...
    boolean isInInterestWindow(int line, int size) {
        if (fInterestWindowSize <= 0) return true;
    ...
    boolean isInInterestWindow(int line) {
        if (fInterestWindowSize <= 0) return true;
        if (line < fInterestWindowStartLine || line >= fInterestWindowStartLine + fInterestWindowSize) return false;
        return true;
    }
    ...
    int fitLineToWindow(int line) {
        if (fInterestWindowSize <= 0) return line;
        if (line < fInterestWindowStartLine) return fInterestWindowStartLine;
        return line;
    }
    ...
    int fitSizeToWindow(int line, int size) {
        if (fInterestWindowSize <= 0) return size;
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#markLineChanged(int)
     */
    public void markLineChanged(int line) {
        if (!isInInterestWindow(line)) return;
        line = fitLineToWindow(line);
        if (line < fFirstChangedLine) fFirstChangedLine = line;
        if (line > fLastChangedLine) fLastChangedLine = line;
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#markLinesChanged(int, int)
     */
    public void markLinesChanged(int line, int n) {
        if (n <= 0 || !isInInterestWindow(line, n)) return;
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#convertScrollingIntoChanges()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#hasChanged()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#scroll(int, int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#setAllChanged(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#getFirstChangedLine()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#getLastChangedLine()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#getScrollWindowStartLine()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#getScrollWindowSize()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#getScrollWindowShift()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#copyChangedLines(org.eclipse.tcf.terminal.model.
     * ITerminalTextData, org.eclipse.tcf.terminal.model.ITerminalTextData)
     */
    public void copyChangedLines(ITerminalTextData dest, ITerminalTextData source) {
        ...
        for (int i = fFirstChangedLine; i < n; i++) {
            if (hasLineChanged(i)) dest.copyLine(source, i, i);
        }
    }
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ISnapshotChanges#hasLineChanged(int)
     */
    public boolean hasLineChanged(int line) {
        if (line < fChangedLines.length) return fChangedLines[line];
