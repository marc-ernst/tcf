...
class TerminalTextDataSnapshot implements ITerminalTextDataSnapshot {
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#snapshot()
     */
    public void updateSnapshot(boolean detectScrolling) {
        ...
        synchronized (fTerminal) {
            ...
            if (fSnapshot.getHeight() != fTerminal.getHeight() || fSnapshot.getWidth() != fTerminal.getWidth()) {
                if (fInterestWindowSize == -1) fSnapshot.setWindow(0, fTerminal.getHeight());
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#getFirstChangedLine()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#getLastChangedLine()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#getScrollChangeY()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#getScrollChangeN()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.model.ITerminalTextDataSnapshot#getScrollChangeShift()
     */
