 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.internal.provisional.api;

import java.io.OutputStream;

import org.eclipse.core.runtime.IAdaptable;
import org.eclipse.tcf.terminal.internal.control.ITerminalViewControl;
import org.eclipse.tcf.terminal.internal.provisional.api.provider.TerminalConnectorImpl;

/**
 * A contributed connection type to manage a single connection.
 *
 * Implementations of this class are contributed through the
 * <code>org.eclipse.tcf.terminal.control.connectors</code> extension point. This
...
public interface ITerminalConnector extends IAdaptable {
     ...
     *         selections.
     * @since org.eclipse.tcf.terminal 3.0.1
     */
    boolean isHidden();
