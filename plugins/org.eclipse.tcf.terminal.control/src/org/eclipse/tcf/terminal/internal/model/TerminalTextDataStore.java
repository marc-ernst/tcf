...
import org.eclipse.tcf.terminal.model.LineSegment;
import org.eclipse.tcf.terminal.model.Style;
...
public class TerminalTextDataStore implements ITerminalTextData {
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#getWidth()
     */
    public int getWidth() {
        return fWidth;
    }
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#getHeight()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setDimensions(int, int)
     */
    public void setDimensions(int height, int width) {
        ...
        if (height > fChars.length) {
            int h = 4 * height / 3;
            if (fMaxHeight > 0 && h > fMaxHeight) h = fMaxHeight;
    ...
    private Object resizeArray(Object origArray, int newSize) {
        ...
        if (oldSize == newSize) return origArray;
        Class<?> elementType = origArray.getClass().getComponentType();
        Object newArray = Array.newInstance(elementType, newSize);
        int preserveLength = Math.min(oldSize, newSize);
        if (preserveLength > 0) System.arraycopy(origArray, 0, newArray, 0, preserveLength);
        return newArray;
    }
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#getLineSegments(int, int, int)
     */
    public LineSegment[] getLineSegments(int line, int column, int len) {
        ...
        if (styles == null) styles = new Style[n];
        else if (styles.length < n) styles = (Style[]) resizeArray(styles, n);

        if (chars == null) chars = new char[n];
        else if (chars.length < n) chars = (char[]) resizeArray(chars, n);
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#getChar(int, int)
     */
    public char getChar(int line, int column) {
        assert column < fWidth || throwRuntimeException();
        if (fChars[line] == null || column >= fChars[line].length) return 0;
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#getStyle(int, int)
     */
    public Style getStyle(int line, int column) {
        assert column < fWidth || throwRuntimeException();
        if (fStyle[line] == null || column >= fStyle[line].length) return null;
        return fStyle[line][column];
    }

    void ensureLineLength(int iLine, int length) {
        if (length > fWidth) throw new RuntimeException();
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChar(int, int, char,
     * org.eclipse.tcf.internal.terminal.text.Style)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChars(int, int, char[],
     * org.eclipse.tcf.internal.terminal.text.Style)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChars(int, int, char[], int, int,
     * org.eclipse.tcf.internal.terminal.text.Style)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#scroll(int, int, int)
     */
    ...
    public char[] getChars(int line) {
        if (fChars[line] == null) return null;
        return fChars[line].clone();
    }

    public Style[] getStyles(int line) {
        if (fStyle[line] == null) return null;
