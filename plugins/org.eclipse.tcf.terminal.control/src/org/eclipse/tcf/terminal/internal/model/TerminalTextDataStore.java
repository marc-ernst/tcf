...
public class TerminalTextDataStore implements ITerminalTextData {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChar(int, int, char, org.eclipse.tcf.internal.terminal.text.Style)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChars(int, int, char[], org.eclipse.tcf.internal.terminal.text.Style)
     */
    public void setChars(int line, int column, char[] chars, Style style) {
        setChars(line,column,chars,0,chars.length,style);
    }
    /* (non-Javadoc)
     * @see org.eclipse.tcf.internal.terminal.text.ITerminalTextData#setChars(int, int, char[], int, int, org.eclipse.tcf.internal.terminal.text.Style)
     */
