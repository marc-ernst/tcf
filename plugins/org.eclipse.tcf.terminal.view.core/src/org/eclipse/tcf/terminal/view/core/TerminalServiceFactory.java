 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.core;
...
import org.eclipse.tcf.terminal.view.core.nls.Messages;
...
public final class TerminalServiceFactory {
    ...
    static {
        ...
        Bundle bundle = Platform.getBundle("org.eclipse.tcf.terminal.view.ui"); //$NON-NLS-1$
        if (bundle != null && bundle.getState() != Bundle.UNINSTALLED && bundle.getState() != Bundle.STOPPING) {
            try {
                Class<?> clazz = bundle.loadClass("org.eclipse.tcf.terminal.view.ui.services.TerminalService"); //$NON-NLS-1$
