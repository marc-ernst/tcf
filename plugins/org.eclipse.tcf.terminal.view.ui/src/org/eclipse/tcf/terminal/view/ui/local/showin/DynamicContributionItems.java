 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.local.showin;
...
public class DynamicContributionItems extends CompoundContributionItem implements IWorkbenchContribution {
    ...
    public void initialize(IServiceLocator serviceLocator) {
        ...
        delegate = LauncherDelegateManager.getInstance().getLauncherDelegate("org.eclipse.tcf.terminal.connector.local.launcher.local", false); //$NON-NLS-1$
    }
