 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.view;
...
import org.eclipse.tcf.terminal.view.ui.tabs.TabFolderManager;
import org.eclipse.tcf.terminal.view.ui.tabs.TabFolderMenuHandler;
import org.eclipse.tcf.terminal.view.ui.tabs.TabFolderToolbarHandler;
...
public class TerminalsView extends ViewPart implements ITerminalsView, IShowInTarget {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ITerminalsView#switchToEmptyPageControl()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ITerminalsView#switchToTabFolderControl()
     */
    @Override
        ...
        if (context != null) {
            ...
            if (selection instanceof IStructuredSelection && !selection.isEmpty()) {
                ...
                if (isValid) {
                    ...
                    Command command = service != null ? service.getCommand("org.eclipse.tcf.terminal.connector.local.command.launch") : null; //$NON-NLS-1$
