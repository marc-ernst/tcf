 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.internal.dialogs;
...
import org.eclipse.tcf.terminal.view.ui.activator.UIPlugin;
import org.eclipse.tcf.terminal.view.ui.controls.ConfigurationPanelControl;
import org.eclipse.tcf.terminal.view.ui.help.IContextHelpIds;
import org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel;
import org.eclipse.tcf.terminal.view.ui.interfaces.IExternalExecutablesProperties;
import org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate;
import org.eclipse.tcf.terminal.view.ui.interfaces.tracing.ITraceIds;
import org.eclipse.tcf.terminal.view.ui.launcher.LauncherDelegateManager;
import org.eclipse.tcf.terminal.view.ui.local.showin.ExternalExecutablesManager;
...
public class LaunchTerminalSettingsDialog extends TrayDialog {
    ...
    protected class SettingsPanelControl extends ConfigurationPanelControl {
        ...
        /* (non-Javadoc)
         * @see org.eclipse.tcf.terminal.view.ui.controls.ConfigurationPanelControl#getGroupLabel()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.eclipse.tcf.terminal.view.ui.controls.ConfigurationPanelControl#showConfigurationPanel(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanelContainer#validate()
         */
        @Override
    ...
    protected List<String> getTerminals() {
        ...
        if(selection==null || selection.isEmpty()){
            ...
            for (ILauncherDelegate delegate : delegates) {
                ...
                if ("org.eclipse.tcf.terminal.connector.local.launcher.local".equals(delegate.getId())) { //$NON-NLS-1$
