...
import org.eclipse.tcf.terminal.internal.provisional.api.NullSettingsStore;
...
public class StreamsConnector extends AbstractStreamsConnector implements IDisposable {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.streams.AbstractStreamsConnector#doDisconnect()
     */
    @Override
