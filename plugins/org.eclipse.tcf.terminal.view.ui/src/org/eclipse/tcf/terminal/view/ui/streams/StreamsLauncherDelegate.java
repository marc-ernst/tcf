 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.streams;
...
import org.eclipse.tcf.terminal.view.core.interfaces.ITerminalServiceOutputStreamMonitorListener;
...
public class StreamsLauncherDelegate extends AbstractLauncherDelegate {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#needsUserConfiguration()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#getPanel(org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanelContainer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#execute(java.util.Map, org.eclipse.tcf.terminal.view.core.interfaces.ITerminalService.Done)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#createTerminalConnector(java.util.Map)
     */
    @Override
    public ITerminalConnector createTerminalConnector(Map<String, Object> properties) {
        ...
        if (connectorId == null) connectorId = "org.eclipse.tcf.terminal.connector.streams.StreamsConnector"; //$NON-NLS-1$
