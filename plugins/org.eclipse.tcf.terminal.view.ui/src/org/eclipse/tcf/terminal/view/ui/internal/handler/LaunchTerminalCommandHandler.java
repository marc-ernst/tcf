 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.internal.handler;
...
import org.eclipse.tcf.terminal.view.core.TerminalContextPropertiesProviderFactory;
import org.eclipse.tcf.terminal.view.core.interfaces.ITerminalContextPropertiesProvider;
import org.eclipse.tcf.terminal.view.core.interfaces.constants.IContextPropertiesConstants;
...
import org.eclipse.tcf.terminal.view.ui.internal.dialogs.LaunchTerminalSettingsDialog;
...
public class LaunchTerminalCommandHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        // "org.eclipse.tcf.terminal.view.ui.command.launchToolbar"
        // "org.eclipse.tcf.terminal.view.ui.command.launch"
        ...
        if (commandId.equals("org.eclipse.tcf.terminal.view.ui.command.launchToolbar")) { //$NON-NLS-1$
            if (UIPlugin.getTraceHandler().isSlotEnabled(0, ITraceIds.TRACE_LAUNCH_TERMINAL_COMMAND_HANDLER)) {
