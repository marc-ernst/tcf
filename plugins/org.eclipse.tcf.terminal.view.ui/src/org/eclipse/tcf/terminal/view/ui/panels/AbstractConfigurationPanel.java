 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.panels;
...
public abstract class AbstractConfigurationPanel implements IConfigurationPanel {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#getContainer()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#dispose()
     */
    @Override
    public void dispose() {
    }
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#getControl()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#setSelection(org.eclipse.jface.viewers.ISelection)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#getSelection()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#doRestoreWidgetValues(org.eclipse.jface.dialogs.IDialogSettings, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#doSaveWidgetValues(org.eclipse.jface.dialogs.IDialogSettings, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#setEnabled(boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#isValid()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#activate()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#extractData(java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#setupData(java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.IConfigurationPanel#updateData(java.util.Map)
     */
    @Override
