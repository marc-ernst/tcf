 ...
 *******************************************************************************/
package org.eclipse.tcf.terminal.view.ui.launcher;
...
public abstract class AbstractLauncherDelegate extends PlatformObject implements ILauncherDelegate {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#getId()
     */
    @Override
    public String getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#getLabel()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#getEnablement()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.tcf.terminal.view.ui.interfaces.ILauncherDelegate#isHidden()
     */
    @Override
