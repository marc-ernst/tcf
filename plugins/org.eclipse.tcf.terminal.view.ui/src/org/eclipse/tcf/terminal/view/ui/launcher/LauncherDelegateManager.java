...
public class LauncherDelegateManager {
     ...
     * <ul><li>Extensions contributed by our own plug-ins (<code>org.eclipse.tcf.terminal.*</code>)
    ...
    /* default */ static class ExtensionPointComparator implements Comparator<IExtension> {
        private final static String OWN_PLUGINS_PATTERN = "org.eclipse.tcf.terminal."; //$NON-NLS-1$
    ...
    protected void loadExtensions() {
        ...
        IExtensionPoint point = registry.getExtensionPoint("org.eclipse.tcf.terminal.view.ui.launcherDelegates"); //$NON-NLS-1$
        if (point != null) {
